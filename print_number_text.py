...
def print_number_hundreds(number_str):
    if(int(number_str)==0):#
        print("Zero")
        return
    ...
    if number_str[0]!='0':#if the number given is >=100
    ...
    if number_str[0]=="0" or number_str[0]=="1":#if number between 1 and 19
...
def print_number_millions(number_str):
    ...
    print_number_millions(number_str[3:])#move on
